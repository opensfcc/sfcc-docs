...
const tabs = [
  { name: 'ConsentTracking.js', isActive: true },
  { name: 'Account.js', isActive: false },
]
      ...
      <div className="py-16 sm:px-2 lg:relative lg:px-0 lg:py-20">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                ...
                <Button href="https://salesforcecommercecloud.github.io/b2c-dev-doc/" target="_blank" variant="secondary">
                  View Official Docs
                </Button>
              </div>
            </div>
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              <Image className="absolute -right-64 -top-64" src={blurCyanImage} alt="" width={530} height={530} unoptimized priority />
              <Image className="absolute -bottom-40 -right-44" src={blurIndigoImage} alt="" width={567} height={567} unoptimized priority />
              ...
              <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur">
                ...
                <div className="pl-4 pt-4">
                  ...
                  <div className="mt-4 flex space-x-2 text-xs">
                    {tabs.map((tab) => (
                      <div key={tab.name} className={clsx('flex h-6 rounded-full', tab.isActive ? 'bg-gradient-to-r from-sky-400/30 via-sky-400 to-sky-400/30 p-px font-medium text-sky-300' : 'text-slate-500')}>
                        <div className={clsx('flex items-center rounded-full px-2.5', tab.isActive && 'bg-slate-800')}>{tab.name}</div>
                      </div>
                    ))}
                  </div>
