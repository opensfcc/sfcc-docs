...
export function VersionSelector(props) {
  ...
  // Temp disable switcher until I decide if I want to keep it
  ...
  if (switchEnabled) {
    ...
    return <span className="flex h-6 w-20 items-center justify-center text-base font-semibold leading-5 text-slate-400">{`v${currentVersion}`}</span>
  }
}
